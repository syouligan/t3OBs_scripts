...
# --------------------------------------------------------------------------
# Find genes differentially expressed in Cerebrocortical_Gil_Ibanez
# --------------------------------------------------------------------------
...
# Set
set = "Cerebrocortical_Gil_Ibanez"

# Load data files and remove trailing decimal from gene ids
gene_count <- read.csv(paste0('data/public_data/', set, '/V1_T3treated_counts.csv'), row.names = 1, header = TRUE)
