...
# --------------------------------------------------------------------------
# Find genes differentially expressed in Striatum_Richard
# --------------------------------------------------------------------------
...
# Set
set = "Striatum_Richard"

# Load data files and remove trailing decimal from gene ids
gene_count <- read.table(paste0('data/public_data/', set, '/GSE144071_Count_Table_FINAL.txt'), row.names = 1, header = TRUE)
...
contrasts <- makeContrasts(Control_PTUT3 = sampleTypePTUT3-sampleTypeControl,
                           Control_PTUOnly = sampleTypePTUOnly-sampleTypeControl,
                           PTUOnly_PTUT3 = sampleTypePTUT3-sampleTypePTUOnly,
                           levels = design )
